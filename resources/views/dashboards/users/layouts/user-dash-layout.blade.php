...
{{--          </li>--}}
            <li class="nav-item">
                <a href="{{ route('emergency.create')}}" class="nav-link {{ (request()->is('emergency-request/*')) ? 'active' : '' }}">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021-2021 <a href="https://adminlte.io">Admin .io</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
